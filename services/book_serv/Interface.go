...
type BookService interface {
	...
	PlusTag(currentUser entities.User, book_id int, tagName string) app_error.AppError
	MinusTag(currentUser entities.User, book_id int, tagName string) app_error.AppError
